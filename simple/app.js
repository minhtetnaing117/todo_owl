...
class Task extends Component{
  static template = xml`
    ...
    class="d-flex align-items-center justify-content-between border p-3 mb-2 rounded">
    <div t-if='state.isEditing' class='d-flex align-items-center flex-grow-1 me-2'>
      ...
      <input type="color" style='width:60px' class="form-control-lg form-control-color border-0 bg-white m-0" id="exampleColorInput" 
          value="#563d7c" title="Choose your color"  t-model='state.color'/>
    </div>
      ...
      <div>
        ...
        <button class="btn btn-danger me-2" t-on-click='deleteTask'><i class="bi bi-trash"></i></button>
      </div>
    </li>`
  ...
  static template = xml`
      <div>
        <div class="input-group-lg w-100 d-flex border rounded align-items-center">
          <input type="text" class="form-control-lg flex-fill border-0 me-1" placeholder="Add your test number" aria-label="Recipient's username" 
          aria-describedby="button-addon2" t-att-value='state.name' t-model='state.name'/>
          <input type="color" class="form-control-lg form-control-color border-0 bg-white m-0" id="exampleColorInput" 
          value="#563d7c" title="Choose your color" t-att-value='state.color' t-model='state.color'/>
          <button class="btn btn-outline-secondary" type="button" id="button-addon2" t-on-click='addTask'><i class="bi bi-plus"></i></button>
        </div>
      </div>
